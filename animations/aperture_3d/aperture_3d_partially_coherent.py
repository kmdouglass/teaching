...
class Aperture3DPartiallyCoherent(Scene):
    def construct(self):
        ...
        incident_ray_partial_down = Arrow(
            start=[-OBJ_WORKING_DISTANCE, OBJ_BARREL_FRONT_HEIGHT, 0],
            end=[0, 0, 0],
            buff=0,
            color=BLUE,
            stroke_width=2,
        ...
        vg_microscope = VGroup(
            ...
            incident_ray_partial_down,
            incident_ray_partial_up,
        ...
        self.play(
            ...
            Create(incident_ray_partial_down),
            Create(incident_ray_partial_up),
        ...
        # Change incident wavevector direction
        change_incident_k_explanation = Text(
            "For each incident plane wave direction...",
            font_size=24,
        )
        change_incident_k_explanation.to_edge(UP)
        self.play(Write(change_incident_k_explanation))
        self.wait(2)
        self.play(FadeOut(change_incident_k_explanation))

        self.play(
            Rotate(k_inc, angle=OBJ_COLLECTION_ANGLE / 2, about_point=[0, 0, 0]),
            rate_func=linear,
        )
        self.wait(1)

        change_incident_k_explanation2 = Text(
            "...a different set of scattered waves is collected.",
            font_size=24,
        )
        change_incident_k_explanation2.to_edge(UP)
        self.play(Write(change_incident_k_explanation2))
        self.wait(2)
        self.play(FadeOut(change_incident_k_explanation2))
        ...
        k_scat_rotation_point = k_scat.get_start()
        self.play(
            Rotate(k_scat, angle=-OBJ_COLLECTION_ANGLE, about_point=k_scat_rotation_point),
            rate_func=linear,
            run_time=2
        )
        self.wait(1)
        ...
        # Rotate the incident wavevector direction
        k_inc_rotation_point = k_inc.get_start()
        bump = 5 * DEGREES
        self.play(
            Rotate(k_inc, angle=-bump, about_point=k_inc_rotation_point),
            rate_func=linear,
            run_time=2
        )
        self.wait(1)
        ...
        # Rotate the incident wavevector again
        self.play(
            Rotate(k_inc, angle=-bump, about_point=k_inc_rotation_point),
            rate_func=linear,
            run_time=2
        ...
        remaining_angles = int(OBJ_COLLECTION_ANGLE / bump) - 2
        for _ in range(remaining_angles):
            self.play(
                Rotate(k_inc, angle=-bump, about_point=k_inc_rotation_point),
                rate_func=linear,
                run_time=0.25
