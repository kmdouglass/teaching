...
The second purpose of the buffer is to open the energetic pathway to the long-lived dark state. As mentioned above, this pathway is enabled by the reduction\footnote{A reduction occurs when a molecule gains of electrons. An oxidation is the opposite process whereby a molecule losses electrons.} of the flourophore when it is in the triplet state. MEA is the reducing agent in the buffer.
