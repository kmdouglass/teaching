...
\begin{equation}
    k_S = \sum_1^N k_{ \left( S, i \right) }
\end{equation}

\noindent Inaccessible states have rate coefficients of zero.

Finally, the probability to transition to a state $S'$ from a state $S$ is given by a multinomial distribution, or
