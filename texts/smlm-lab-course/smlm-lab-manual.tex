...
\section{Basics of ON/OFF Switching}
...
\begin{figure}[ht]
    ...
    \caption{Energy level diagram of flourophores from the AlexaFluor and ATTO families. From van de Linde, \textit{et al.}, "Direct stochastic optical reconstruction microscopy with standard fluorescent probes," Nature Propocols 6, 991 (2011).}
