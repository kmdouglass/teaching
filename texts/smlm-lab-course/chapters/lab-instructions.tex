...
When you are done acquiring data, clean up the microscope objective as described in \ref{sec:remove-oil}.
...
In your final report, you should answer the following questions:
